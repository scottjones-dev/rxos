...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(&application, &QCoreApplication::aboutToQuit, &application,
        ...
        qInfo().noquote()
            << QStringLiteral(R"({"component":"driver-display","event":"shutdown_summary","uptimeMs":%1,"accepted":%2,"received":%3,"lagged":%4,"lastSequence":%5,"renderedFrames":%6,"chartSamples":%7,"chartPublished":%8,"chartRenderedPoints":%9,"presentationUpdates":%10,"presentationReplacements":%11,"hiddenWork":%12})")
                   .arg(startupTimer.elapsed())
        ...
        qInfo().noquote() << frameTiming.summary(QStringLiteral("driver-display"));
    });
